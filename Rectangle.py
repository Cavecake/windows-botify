class Rect:
    def __init__(self, *args):
        if len(args) == 2 and all(isinstance(arg, (list, tuple)) and len(arg) == 2 for arg in args):
            ...
            raise ValueError("Invalid arguments. Use either (point1, point2) or (point1, width, height)")
